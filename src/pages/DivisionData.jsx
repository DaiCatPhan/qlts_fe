...
function DivisionData() {
  ...
  function handleOpenContact(segment) {
    if (!segment.usermanager) {
      return toast.warning("Bạn cần phân quyền cho Usermanager để mở liên hệ.");
    }
    setSegmentEditOpen(segment);
    onOpenOpenContact();
  }

  function handleOpenContactAll() {
    onOpenOpenContact();
  }
    ...
    <div className="p-6 bg-white min-h-[425px] rounded-lg shadow">
      <div className="mb-6">
        ...
        <div className="mb-4 grid grid-cols-12 gap-6">
          ...
          <div className="col-span-2 w-full">
            <h4 className="text-base font-medium mb-2">Năm tạo đoạn</h4>
            <div className="grid grid-cols-12 gap-4">
              <div className="col-span-12">
                <Autocomplete
                  isClearable={false}
